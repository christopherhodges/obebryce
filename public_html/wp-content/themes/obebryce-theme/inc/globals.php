...
define( 'IMAGES', STYLEDIR. "/images");
    define( 'IMAGES_SERVER', spark_get_stylesheet_path(). "/images");
...
### spark_get_home_path() is the exact same function, except in name.
...
function spark_get_stylesheet_path() {
    $return = false;
    $home_path = spark_get_home_path();
